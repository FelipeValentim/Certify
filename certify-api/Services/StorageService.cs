...
namespace Services
{
    ...
    {
        static string accountId = "PLACEHOLDER_1";  // Sua chave de acesso
        static string accessKeyId = "PLACEHOLDER_2";
        static string secretAccessKey = "PLACEHOLDER_3";  // Sua chave secreta
