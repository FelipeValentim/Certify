...
namespace Services
{
	public class EventService : IEventService
	{
		...
		public EventService(IEventRepository eventRepository,  IStorageService storageService, IDocumentService documentService, IWebHostEnvironment webHostEnvironment, IEventTemplateRepository eventTemplateRepository)
		{
